...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "luxon", "@n8n/errors", "@n8n/expression-runtime", "./errors/expression-extension.error", "./errors/expression.error", "./expression-evaluator-proxy", "./expression-sandboxing", "./expressions/expression-helpers", "./logger-proxy", "./extensions", "./extensions/expression-extension", "./extensions/extended-functions", "./global-state", "./run-execution-data-factory", "./workflow-data-proxy"], factory);
    }
    ...
    class Expression {
        ...
        renderExpression(expression, data) {
            ...
            if (Expression.expressionEngine === 'vm' && !IS_FRONTEND) {
                if (!Expression.vmEvaluator) {
                    throw new errors_1.ApplicationError('N8N_EXPRESSION_ENGINE=vm is enabled but VM evaluator is not initialized. Call Expression.initExpressionEngine() during application startup.');
                }
                try {
