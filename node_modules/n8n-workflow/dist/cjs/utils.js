...
(function (factory) {
    ...
    exports.containsUnsafeObjectPropertyToken = containsUnsafeObjectPropertyToken;
    ...
    const unsafeObjectPropertyTokenPattern = new RegExp(`\\b(?:${[...unsafeObjectProperties]
        .map((p) => p.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'))
        .join('|')})\\b`);
    function containsUnsafeObjectPropertyToken(input) {
