...
import { createDeepLazyProxy, isArrayMetadata, isObjectMetadata, throwIfErrorSentinel, } from './lazy-proxy';
 ...
 */
export function buildContext(getValueAtPath, getArrayElement, callFunctionAtPath, timezone) {
    ...
    function resolveFromHost(key) {
        ...
        if (isArrayMetadata(value)) {
            target[key] = createDeepLazyProxy([key], { kind: 'array', length: value.__length }, callbacks);
            return true;
        }
