...
export function isObjectMetadata(value) {
    return (typeof value === 'object' &&
        value !== null &&
        '__isObject' in value &&
        value.__isObject === true);
}
export function isArrayMetadata(value) {
...
export function getProxyPath(obj) {
 ...
 */
export function createDeepLazyProxy(basePath = [], meta, callbacks) {
    if (!callbacks) {
