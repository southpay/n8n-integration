...
export declare class PoolDisposedError extends IsolateError {
    constructor();
}
export declare class PoolExhaustedError extends IsolateError {
    constructor();
}
...
export declare class IsolatePool implements IPool {
